package com.bn.ZDR.fbx.core.normal;
...
import com.bn.ZDR.fbx.core.LoadTextrueUtil;
...
public class BnggdhDraw
{
	...
	public BnggdhDraw(InputStream is, MyGLSurfaceView mv, String path)
	{
	...
	public void draw()
	{
		...
		GLES30.glUniformMatrix4fv(muMMatrixHandle, 1, false,
				MatrixState3D.getMMatrix(), 0);
		// 将摄像机位置传入shader程序
		GLES30.glUniform3fv(muCameraHandle, 1, MatrixState3D.cameraFB);
		// 将摄像机位置传入shader程序
		GLES30.glUniform3fv(muLightHandle, 1, MatrixState3D.lightPositionFB);

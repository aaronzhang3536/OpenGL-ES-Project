...
public class LoadUtil
{
	...
	(String fname, Resources r,MyGLSurfaceView mv)
	{
		//加载后物体的引用
		...
		try
		{
			InputStream in=r.getAssets().open(Constant.ObjPath+fname);
	...
	@SuppressLint("UseSparseArrays")
	public static LoadedObjectVertexNormalTextureBullet loadFromFileBullet
			(String fname, Resources r,MyGLSurfaceView mv)
	{
		//加载后物体的引用
		LoadedObjectVertexNormalTextureBullet lo=null;
		//原始顶点坐标列表--直接从obj文件中加载
		ArrayList<Float> alv=new ArrayList<Float>();
		//顶点组装面索引列表--根据面的信息从文件中加载
		ArrayList<Integer> alFaceIndex=new ArrayList<Integer>();
		...
		try
		{
			...
			//创建3D物体对象
			lo=new LoadedObjectVertexNormalTextureBullet(mv,vXYZ,nXYZ,tST);
		}
		catch(Exception e)
		{
			Log.d("load error", "load error");
...
//	@SuppressLint("UseSparseArrays")
//	public static LoadedObjectVertexNormalTex loadFromFiletex
//			(String fname, Resources r,MyGLSurfaceView mv)
//	{
//		//加载后物体的引用
//		LoadedObjectVertexNormalTex lo=null;
//		//原始顶点坐标列表--直接从obj文件中加载
//		ArrayList<Float> alv=new ArrayList<Float>();
//		//顶点组装面索引列表--根据面的信息从文件中加载
//		ArrayList<Integer> alFaceIndex=new ArrayList<Integer>();
...
//			}
//			//创建3D物体对象
//			lo=new LoadedObjectVertexNormalTex(mv,vXYZ,nXYZ,tST);
//		}
//		catch(Exception e)
//		{
//			Log.d("load error", "load error");
...
//	//从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
//	@SuppressLint("UseSparseArrays")
//	public static LoadedObjectVertexNormalTextureObjTouch loadFromFileot
//	(String fname, Resources r,MyGLSurfaceView mv)
//	{
//		//加载后物体的引用
//		LoadedObjectVertexNormalTextureObjTouch lo=null;
//		//原始顶点坐标列表--直接从obj文件中加载
//		ArrayList<Float> alv=new ArrayList<Float>();
//		//顶点组装面索引列表--根据面的信息从文件中加载
//		ArrayList<Integer> alFaceIndex=new ArrayList<Integer>();
...
//			}
//			//创建3D物体对象
//			lo=new LoadedObjectVertexNormalTextureObjTouch(mv,vXYZ,nXYZ,tST);
//		}
//		catch(Exception e)
//		{
//			Log.d("load error", "load error");

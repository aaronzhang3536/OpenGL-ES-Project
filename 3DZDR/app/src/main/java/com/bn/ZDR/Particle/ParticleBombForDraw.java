...
import static com.bn.ZDR.Particle.ParticleBombDataConstant.lock;
...
//纹理三角形
public class ParticleBombForDraw
{
    ...
    public ParticleBombForDraw(MyGLSurfaceView mv, float halfSize)
    {//构造器

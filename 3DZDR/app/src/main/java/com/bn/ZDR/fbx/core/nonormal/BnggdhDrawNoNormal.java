package com.bn.ZDR.fbx.core.nonormal;
...
public class BnggdhDrawNoNormal
{
	...
	public BnggdhDrawNoNormal(InputStream is, MyGLSurfaceView mv, String path)
	{
		bnn = new Bnggdh(is);
		try {
			bnn.init();
...
//      //将光源位置传入着色器程序
		GLES30.glUniform3fv(maLightLocationHandle, 1, MatrixState3D.lightPositionFB);
		//将摄像机位置传入着色器程序
